...
const EmailSchema = z
  .object({
    ...
    created_at: z
      .string()
      .datetime()
      .openapi({ example: "2023_04_03T22:13:42.674981+00:00" }),
...
const DomainSchema = z
  .object({
    ...
    created_at: z
      .string()
      .datetime()
      .openapi({ example: "2023_04_26T20:21:26.347412+00:00" }),
...
const CreateAudienceOptionsSchema = z
  .object({ name: z.string() })
  .openapi("CreateAudienceOptions");
    ...
    data: z.array(
      z
        .object({
          id: z
            .string()
            .openapi({ example: "78261eea_8f8b_4381_83c6_79fa7120f1cf" }),
          name: z.string().openapi({ example: "Registered Users" }),
          created_at: z
            .string()
            .datetime()
            .openapi({ example: "2023_10_06T22:59:55.977Z" }),
        })
        .partial(),
    ),
  })
...
const GetContactResponseSuccessSchema = z
  .object({
    ...
    created_at: z
      .string()
      .datetime()
      .openapi({ example: "2023_10_06T23:47:56.678Z" }),
    ...
    data: z.array(
      z
        .object({
          id: z
            .string()
            .openapi({ example: "e169aa45_1ecf_4183_9955_b1499d5701d3" }),
          email: z.string().openapi({ example: "steve.wozniak@gmail.com" }),
          first_name: z.string().openapi({ example: "Steve" }),
          last_name: z.string().openapi({ example: "Wozniak" }),
          created_at: z
...
const CreateBroadcastOptionsSchema = z
  .object({
    ...
    preview_text: z
      .string()
      .openapi({ example: "Here are our announcements" })
      .optional(),
    html: z.string().optional(),
    text: z.string().optional(),
  })
...
export const postEmailsBatchRoute = createRoute({
  ...
  request: {
    body: {
      required: false,
      content: {
        "application/json": { schema: z.array(SendEmailRequestSchema) },
      },
    },
  },
  responses: {
    200: {
      description: "OK",
      content: {
        "application/json": { schema: CreateBatchEmailsResponseSchema },
      },
    },
  },
});
...
export const patchDomainsDomain_idRoute = createRoute({
  ...
  responses: {
    200: {
      description: "OK",
      content: {
        "application/json": { schema: UpdateDomainResponseSuccessSchema },
      },
    },
  },
});
...
export const postAudiencesRoute = createRoute({
  ...
  responses: {
    201: {
      description: "OK",
      content: {
        "application/json": { schema: CreateAudienceResponseSuccessSchema },
      },
    },
  },
});
...
export const getAudiencesRoute = createRoute({
  ...
  responses: {
    200: {
      description: "OK",
      content: {
        "application/json": { schema: ListAudiencesResponseSuccessSchema },
      },
    },
  },
});
...
export const deleteAudiencesIdRoute = createRoute({
  ...
  responses: {
    200: {
      description: "OK",
      content: {
        "application/json": { schema: RemoveAudienceResponseSuccessSchema },
      },
    },
  },
});
...
export const getAudiencesIdRoute = createRoute({
  ...
  responses: {
    200: {
      description: "OK",
      content: {
        "application/json": { schema: GetAudienceResponseSuccessSchema },
      },
    },
  },
});
...
export const postAudiencesAudience_idContactsRoute = createRoute({
  ...
  responses: {
    201: {
      description: "OK",
      content: {
        "application/json": { schema: CreateContactResponseSuccessSchema },
      },
    },
  },
});
...
export const getAudiencesAudience_idContactsRoute = createRoute({
  ...
  responses: {
    200: {
      description: "OK",
      content: {
        "application/json": { schema: ListContactsResponseSuccessSchema },
      },
    },
  },
});
...
export const deleteAudiencesAudience_idContactsEmailRoute = createRoute({
  ...
  responses: {
    200: {
      description: "OK",
      content: {
        "application/json": { schema: RemoveContactResponseSuccessSchema },
      },
    },
  },
});
...
export const getAudiencesAudience_idContactsIdRoute = createRoute({
  ...
  responses: {
    200: {
      description: "OK",
      content: {
        "application/json": { schema: GetContactResponseSuccessSchema },
      },
    },
  },
});
...
export const patchAudiencesAudience_idContactsIdRoute = createRoute({
  ...
  responses: {
    200: {
      description: "OK",
      content: {
        "application/json": { schema: UpdateContactResponseSuccessSchema },
      },
    },
  },
});
...
export const postBroadcastsRoute = createRoute({
  ...
  responses: {
    201: {
      description: "OK",
      content: {
        "application/json": { schema: CreateBroadcastResponseSuccessSchema },
      },
    },
  },
});
...
export const getBroadcastsRoute = createRoute({
  ...
  responses: {
    200: {
      description: "OK",
      content: {
        "application/json": { schema: ListBroadcastsResponseSuccessSchema },
      },
    },
  },
});
...
export const deleteBroadcastsIdRoute = createRoute({
  ...
  responses: {
    200: {
      description: "OK",
      content: {
        "application/json": { schema: RemoveBroadcastResponseSuccessSchema },
      },
    },
  },
});
...
export const getBroadcastsIdRoute = createRoute({
  ...
  responses: {
    200: {
      description: "OK",
      content: {
        "application/json": { schema: GetBroadcastResponseSuccessSchema },
      },
    },
  },
});
...
export const postBroadcastsIdSendRoute = createRoute({
  ...
  responses: {
    200: {
      description: "OK",
      content: {
        "application/json": { schema: SendBroadcastResponseSuccessSchema },
      },
    },
  },
});
